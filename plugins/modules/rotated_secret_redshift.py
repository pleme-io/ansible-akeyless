...
def main():
    run_standard_crud(
        ...
        resource_label="rotated_secret_redshift",
        sdk_create=("RotatedSecretCreateRedshift", "rotated_secret_create_redshift"),
        sdk_update=("RotatedSecretUpdateRedshift", "rotated_secret_update_redshift"),
