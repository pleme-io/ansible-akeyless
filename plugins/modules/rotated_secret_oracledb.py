...
def main():
    run_standard_crud(
        ...
        resource_label="rotated_secret_oracledb",
        sdk_create=("RotatedSecretCreateOracledb", "rotated_secret_create_oracledb"),
        sdk_update=("RotatedSecretUpdateOracledb", "rotated_secret_update_oracledb"),
