...
def main():
    run_standard_crud(
        ...
        resource_label='rotated_secret_postgresql',
        sdk_create=('RotatedSecretCreatePostgresql', 'rotated_secret_create_postgresql'),
        sdk_update=('RotatedSecretUpdatePostgresql', 'rotated_secret_update_postgresql'),
