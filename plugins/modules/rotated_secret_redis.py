...
def main():
    run_standard_crud(
        ...
        resource_label='rotated_secret_redis',
        sdk_create=('RotatedSecretCreateRedis', 'rotated_secret_create_redis'),
        sdk_update=('RotatedSecretUpdateRedis', 'rotated_secret_update_redis'),
