...
def main():
    run_standard_crud(
        ...
        resource_label="rotated_secret_cassandra",
        sdk_create=("RotatedSecretCreateCassandra", "rotated_secret_create_cassandra"),
        sdk_update=("RotatedSecretUpdateCassandra", "rotated_secret_update_cassandra"),
