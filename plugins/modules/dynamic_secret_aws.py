...
def main():
    argument_spec = {
        ...
        'aws_access_key_id': {'type': 'str', 'no_log': True, 'required': True},
        'aws_access_secret_key': {'type': 'str', 'no_log': True, 'required': True},
    ...
    if not drift:
        module.exit_json(changed=False, msg="dynamic_secret_aws already in desired state")
