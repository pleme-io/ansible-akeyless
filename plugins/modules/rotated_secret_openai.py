...
def main():
    run_standard_crud(
        ...
        resource_label='rotated_secret_openai',
        sdk_create=('RotatedSecretCreateOpenAI', 'rotated_secret_create_open_ai'),
        sdk_update=('RotatedSecretUpdateOpenAI', 'rotated_secret_update_open_ai'),
