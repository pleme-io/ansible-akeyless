...
def main():
    run_standard_crud(
        ...
        resource_label='rotated_secret_dockerhub',
        sdk_create=('RotatedSecretCreateDockerhub', 'rotated_secret_create_dockerhub'),
        sdk_update=('RotatedSecretUpdateDockerhub', 'rotated_secret_update_dockerhub'),
