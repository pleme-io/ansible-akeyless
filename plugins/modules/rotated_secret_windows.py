...
def main():
    run_standard_crud(
        ...
        resource_label='rotated_secret_windows',
        sdk_create=('RotatedSecretCreateWindows', 'rotated_secret_create_windows'),
        sdk_update=('RotatedSecretUpdateWindows', 'rotated_secret_update_windows'),
