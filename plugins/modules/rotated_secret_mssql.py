...
def main():
    run_standard_crud(
        ...
        resource_label='rotated_secret_mssql',
        sdk_create=('RotatedSecretCreateMssql', 'rotated_secret_create_mssql'),
        sdk_update=('RotatedSecretUpdateMssql', 'rotated_secret_update_mssql'),
